...
const Quotes = () => {
  ...
  return (
    <div className="font-bold px-6 sm:p-6 md:p-8 py-6 sm:py-8  text-[var(--color-secondary-text)] rounded-md mt-10 sm:mt-16 md:mt-20 sm:mx-8 md:mx-auto max-w-md sm:max-w-lg md:max-w-3xl text-center transition-all duration-300 ">
