  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <a
        ...
        className="w-6 h-6 text-[var(--color-secondary-text)] transition-all duration-300 ease-[cubic-bezier(0.77,0,0.175,1)] hover:scale-110 hover:text-[var(--color-accent)]"
      >
        <span>
          <svg
