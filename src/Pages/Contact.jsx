...
const Contact = () => {
  ...
  return (
    <div className="relative max-w-3xl m-auto px-4 md:px-8">
      {/* Header */}
      <div className="text-center mt-6 pb-4 border-b flex items-center flex-col gap-5">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="px-4 text-[var(--color-text)] py-2 text-sm rounded-md border border-dashed outline-none 
